...
var changeModalState = function changeModalState(state) {
  ...
  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_1__["default"])('#heigth');
...
var forms = function forms() {
  ...
  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_5__["default"])('input[name="user_phone"]'); // обьект сообщений
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      item.appendChild(statusMessage); //собираем все введенные данные из формы через конструктор

      var formData = new FormData(item); //отправляем запрос на сервер с данными которые получил FormData
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var trigger = document.querySelectorAll(triggerSelector),
        ...
        windows = document.querySelectorAll('[data-modal]'); // trigger.addEventListener("click",(e) => {
    //     if (e.target) {
    //         e.preventDefault();
    //     }
  ...
  bindModal('.popup_calc_profile_button ', '.popup_calc_end', '.popup_calc_close', false); // открывает модал окно каждые 60 сек.
...
var tabs = function tabs(HeaderSelector, tabSelector, contentSelector, activeClass) {
  ...
  header.addEventListener('click', function (e) {
    var target = e.target; //уюедились что кликнули в таб
