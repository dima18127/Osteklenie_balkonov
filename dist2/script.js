...
var forms = function forms() {
  ...
  phoneInputs.foreach(function (item) {
    item.addEventListenter('input', function () {
  ...
  var clearInputs = function clearInputs() {
    clearInputs.foreach(function (item) {
      item.value = ' ';
    });
  ...
  form.foreach(function (item) {
    item.addEventListenter('submit', function (e) {
      e.preventDefault();
      var statusMessage = document.createElement('div');
      statusMessage.classList.add('status');
      item.appendChild(statusMessage); //собираем все введенные данные из формы
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    var trigger = document.querySelectorAll(triggerSelector),
        ...
        close = document.querySelector(closeSelector); // trigger.addEventListener("click",(e) => {
    //     if (e.target) {
    //         e.preventDefault();
    //     }
  ...
  bindModal('.phone_link', '.popup', '.popup .popup_close'); // открывает модал окно каждые 60 сек.
